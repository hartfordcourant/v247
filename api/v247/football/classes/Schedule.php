  ...
  /**
    ...
    public function getWeek($season){
        ...
        switch ($today) {
            ...
            case $today >= $weeks[10][0] && $today < $weeks[11][0]: return 11; break;
            case $today >= $weeks[11][0] && $today < $weeks[12][0]: return 12; break;
            case $today > $weeks[12][0]: return 1; break;
            default: return 1;
        }
    }
    /*
    ...
    function getDisplayPeriod($season, $period){
        ...
        if(strlen($period) == 10){
            ...
            switch ($period) {
                ...
                case $period >= $periods[11][0] && $period <= $periods[11][1]: return $periods[11];  break;
                case $period >= $periods[12][0] && $period <= $periods[12][1]: return $periods[12];  break;
                case $period >= $periods[13][0] && $period <= $periods[13][1]: return $periods[13];  break;
                //case $period >= $periods[14][0] && $period <= $periods[14][1]: return $periods[14];  break;
