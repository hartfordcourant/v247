  ...
  private function buildPage($leagues,$weeks,$wk){
    ...
    $graphic .= "<div id='branding'>
                  ...
                  <ul>
                    ...
                    <li class='active'><a href='hc-boys-high-school-soccer-results-htmlstory.html'>Boys Soccer</a></li>
                  </ul>
                  </nav></div></div>
                  <div id='mobile'>
                  <nav>
    ...
    //$graphic .= "<script src='http://hc-assets.s3.amazonaws.com/js/v247-api-boys-soccer.js'></script>";
    $graphic .= "<script src='assets/js/v247-api-boys-soccer.js'></script>";
