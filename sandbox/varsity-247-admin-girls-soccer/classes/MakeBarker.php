...
class MakeBarker{
	...
	private function buildScoreboard($games){
		...
		$scoreboard = "<link href='http://hc-assets.s3.amazonaws.com/css/hs-scores-barker.css' rel='stylesheet' type='text/css'>
					   <style>div#barker_container{height:165px;max-width:1280px}div#barker_container div#hed_dropdown{width:100%;margin-bottom:4px}div#barker_container div#hed_dropdown h1,div#barker_container div#hed_dropdown img{display:none}div#barker_container div#buttons{left:20px;top:7px}div#barker_container div#buttons a img{width:30px;height:30px}div#barker_container div#barker{height:auto}div#barker_container .score_card{min-width:200px;min-height:0}div#barker_container table{line-height:150%}div#barker_container .info{min-height:0;font-family:Arial,Helvetica,sans-serif;font-size:12px}div#barker_container table tr.links td{width:150px}div#barker_container .links{color:#386b8d}div#barker_container .links a{text-decoration:none;font-family:Arial,Helvetica,sans-serif;font-weight:700;color:#386b8d;text-transform:uppercase;font-size:11px}div#barker_container .links a:hover{color:#ccc}@media only screen and (min-width:480px){div#barker_container div#hed_dropdown{margin-bottom:0;padding-bottom:8px;padding-top:10px}div#barker_container div#hed_dropdown h1{display:block}div#barker_container div#buttons{left:220px;top:7px}}@media only screen and (min-width:768px){div#barker_container div#hed_dropdown img{display:inline-block}div#barker_container div#buttons{left:310px}}@media only screen and (-webkit-min-device-pixel-ratio:2),only screen and (min-resolution:192dpi){div#barker_container div#hed_dropdown h1{display:block}div#barker_container div#hed_dropdown img{display:none}div#barker_container div#buttons{left:220px;top:10px}}</style>
		               <div class='group' id='barker_container'>
	                   <div id='hed_dropdown'><a href='http://www.courant.com/sports/high-schools/" . P2P_STORY_SLUG . "-htmlstory.html' target='_blank'><img src='http://hc-assets.s3.amazonaws.com/logos/varsity_24_7_logo.png' alt='varsity 24/7' /><h1>Girls Soccer</h1></a><select id='leagues'></select></div>
	                   <div id='buttons'>
		...
		foreach($games AS $game){
		    ...
		    elseif($game['away_h1'] != NULL && $game['away_final'] == NULL){
		    	$away_score = ($game['away_h1'] + $game['away_h2'] + $game['away_ot']);
		    	$home_score = ($game['home_h1'] + $game['home_h2'] + $game['home_ot']);
		    }
		    else{
				$away_score = '-';
		    	$home_score = '-';
		    ...
		    $scoreboard .= "<div class='score_card'>
		                    ...
		                    <td class='away_team_score'>{$away_score}{$pka}</td>
		                    </tr>
		                    <tr class='home_team'>
		                    <td class='home_team_name'>{$home_team}</td>
		                    <td class='home_team_score'>{$home_score}{$pkh}</td>
		                    </tr>
		                    <tr class='links'><td class='story_link'><a target='_blank' href='http://www.courant.com/sports/high-schools/" . P2P_STORY_SLUG . "-htmlstory.html'>Full Scoreboard</a></td></tr>
		                    </tbody></table>
		                    </div>
		                    </div>";
	    }
	    $scoreboard .= "</div>
	    				<div id='score_links'>
	    				  <p>Varsity 24/7: 
						    <a target='_parent' href='http://www.courant.com/sports/high-schools/" . V247_FOOT . "-htmlstory.html'>Football</a>
