...
class MakeBarker{               
	...
	private function buildScoreboard($games){
		...
		$scoreboard = "<link href='http://hc-assets.s3.amazonaws.com/css/hs-scores-barker.css' rel='stylesheet' type='text/css'>
	                   ...
	                   <div id='hed_dropdown'><a href='http://www.courant.com/sports/high-schools/" . P2P_STORY_SLUG . "-htmlstory.html' target='_blank'><img src='http://hc-assets.s3.amazonaws.com/logos/varsity_24_7_logo.png' alt='varsity 24/7' /><h1>Boys Soccer</h1></a><select id='leagues'></select></div>
	                   <div id='buttons'>
